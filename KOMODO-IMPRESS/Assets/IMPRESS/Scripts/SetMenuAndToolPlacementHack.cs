    ...
    public class SetMenuAndToolPlacementHack : MonoBehaviour
    {
        ...
        public void Start ()
        {
            ...
            playerRefs.LeftHandSwitchMenuAction.onFirstClick.AddListener(() =>
            {
                ...
                ImpressEventManager.TriggerEvent("tools.setRightHanded");
            });
            ...
            playerRefs.RightHandSwitchMenuAction.onFirstClick.AddListener(() =>
            {
                ...
                ImpressEventManager.TriggerEvent("tools.setLeftHanded");
            });
        ...
        public void Update ()
        {
            ...
            if (_wasInVRLastFrame && !isInVRThisFrame)
            {
                ...
                ImpressEventManager.TriggerEvent("menu.setScreen");

                ImpressEventManager.TriggerEvent("tools.setScreen");
