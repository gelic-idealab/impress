...
namespace Komodo.IMPRESS
{
    public class ToolPlacement : MonoBehaviour
    {
        ...
        public void Start ()
        {
            ImpressEventManager.StartListening("tools.setRightHanded", () =>
            {
                SetCurrentToolAnchor(ToolAnchor.Kind.RIGHT_HANDED);
            });

            ImpressEventManager.StartListening("tools.setLeftHanded", () =>
            {
                SetCurrentToolAnchor(ToolAnchor.Kind.LEFT_HANDED);
            });

            ImpressEventManager.StartListening("tools.setScreen", () =>
            {
